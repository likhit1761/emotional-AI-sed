...
emotion_arr = ['Anger', 'Neutral', 'Fear', 'Happy', 'Sad', 'Surprise']
label_map = ['inspirational', 'feel good', 'soft paced', 'happy', 'motivational', 'rocking']
...
def emotion_detect():
    ...
    emotion = emotion_arr[prediction]
    prediction = label_map[prediction]
    cap.release()
    link = f"https://www.youtube.com/results?search_query={info['singer']}+ {info['language']}+ {prediction}+ songs"
